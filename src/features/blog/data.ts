...
export const posts: BlogPost[] = [
  {
    ...
    readTime: "5 min read",
    authorBio:
      "Hanzala Shaikh is the Founder & CEO of Beacon Martech and the driving force behind B2B Insight Panel. He focuses on building trusted research communities that connect organizations with verified professionals and decision-makers worldwide.",
    intro:
